...
CREATE TABLE `que` (
  ...
  `vote` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', '1', '1'),
(3, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', '1', '0'),
(4, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', '1', '0'),
(5, '舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', '1', '1'),
...
(1, '111', '222', '22', 0),
(2, 'admin', '1234', 'admin@labor.gov.tw', 1),
(3, 'test', '5678', 'test@labor.gov.tw', 0);
...
INSERT INTO `visit` (`id`, `time`, `count`) VALUES
(1, '1530547200', '4');
